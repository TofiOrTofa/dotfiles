...
export PATH="$HOME/.local/state/nix/profiles/profile-33-link/bin:$PATH"
export PATH="/nix/store/akn86ngnghj40fvmpvljv5g2wycirc09-home-manager-0-unstable-2026-04-24/bin:$PATH"
